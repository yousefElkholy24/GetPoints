<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddSlider.aspx.cs" Inherits="GetPointAdmin.Admin.Slider.AddSlider" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
     ...
     <div class="container-fluid">
        <div class="row">
            <p class="col-12 demo-content-title"> Add New Slider</p>
        </div>
        <div class="row">
            <div class="col-12">
                <dx:BootstrapFormLayout ID="AddSliderForm" runat="server" AlignItemCaptionsInAllGroups="True">

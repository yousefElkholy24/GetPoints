<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Terms.aspx.cs" Inherits="GetPointAdmin.Admin.Configuration.Terms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <dx:ASPxHtmlEditor ID="TermsEditor" runat="server" Height="370px" Width="100%">
                    <SettingsDialogs>
                        <InsertImageDialog>
                ...
                <dx:BootstrapButton runat="server" Text="Save" ID="TermsSave" OnClick="TermsSave_Click"></dx:BootstrapButton>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="LoginScreen.aspx.cs" Inherits="GetPointAdmin.Admin.Configuration.LoginScreen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
      ...
      <div class="container-fluid">
        <div class="row">
            <p class="col-12 demo-content-title"> Edit Login Page Screen Image</p>
        </div>
           <div class="row">
            <div class="col-6">
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:GetPointConnectionString2 %>' SelectCommand="SELECT [Info] FROM [tbl_Systemconfig] WHERE ([ID] = @ID2)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="4" Name="ID2" Type="Int32"></asp:Parameter>
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <dx:BootstrapFormLayout ID="EditLoginPic" runat="server" AlignItemCaptionsInAllGroups="True" DataSourceID="SqlDataSource1">
                    <Items>
                        <dx:BootstrapLayoutItem FieldName="Info" Caption="Pic">
                            <ContentCollection>

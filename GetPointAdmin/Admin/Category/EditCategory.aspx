<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditCategory.aspx.cs" Inherits="GetPointAdmin.Admin.Category.EditCategory" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="container-fluid">
        <div class="row">
            <p class="col-12 demo-content-title">Edit Category</p>
        </div>
        <div class="row"> 
            <div class="col-12">
                           ...
                           <ContentCollection>
                                <dx:ContentControl runat="server">
                                    <dx:BootstrapTextBox runat="server" ID="txtTitleAr">
                                        <ValidationSettings RequiredField-IsRequired="true"></ValidationSettings>                                    </dx:BootstrapTextBox>
                                </dx:ContentControl>
                            </ContentCollection>

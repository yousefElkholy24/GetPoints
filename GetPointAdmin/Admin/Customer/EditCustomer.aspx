<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditCustomer.aspx.cs" Inherits="GetPointAdmin.Admin.Customer.EditCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
     ...
     <div class="container-fluid">
        <div class="row">
            <p class="col-12 demo-content-title">Edit Customer</p>
        </div>
        <div class="row">
            <div class="col-12">

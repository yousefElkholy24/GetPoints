<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="GetPointAdmin.Header" %>
        ...
        <Items>
            ...
            <dx:BootstrapToolbarItem AdaptivePriority="2" Text="User Settings"
                ...
                <TextTemplate>
                    ...
                    <span onclick="~/Account/Login.aspx">User Name</span>
                </TextTemplate>
                <Items>
                    <dx:BootstrapToolbarMenuItem Name="navigate_profile" Text="Profile" IconCssClass="demo-icon demo-icon-user" />
                    <dx:BootstrapToolbarMenuItem Name="logout" Text="Logout" IconCssClass="demo-icon demo-icon-logout" NavigateUrl="~/Admin/Account/Logout.aspx"  />
                </Items>
            </dx:BootstrapToolbarItem>
            <dx:BootstrapToolbarItem Name="show_messages" IconCssClass="demo-icon demo-icon-mail" CssClass="rounded-circle shadow ml-2 demo-item-wb" Visible="false">
                <Badge Text="8" CssClass="demo-badge-floating bg-success text-white" />
            </dx:BootstrapToolbarItem>
            <dx:BootstrapToolbarItem Name="show_notifications" IconCssClass="demo-icon demo-icon-alert" CssClass="rounded-circle shadow ml-2 demo-item-wb" Visible="false">

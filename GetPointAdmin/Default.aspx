<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GetPointAdmin.Default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <div class="jumbotron">
      <div class="container">
        ...
        <p><dx:BootstrapButton ID="Button7" runat="server" Text="Learn more &raquo;" AutoPostBack="false">
            <SettingsBootstrap RenderOption="Primary" Sizing="Large" />
